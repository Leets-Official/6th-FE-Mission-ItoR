...
export function Button({
  ...
  const variants = {
    primary:
      "border border-[#00A1FF] text-[#00A1FF] bg-white hover:bg-[#E6F7FF] disabled:border-gray-300 disabled:text-gray-300",
    secondary:
      "border border-[#909090] text-[#909090] bg-white hover:bg-gray-100 disabled:text-gray-300",
    flat:
      "bg-white text-[#909090] hover:bg-gray-50 disabled:text-gray-300",
    tertiary:
      "border border-[#909090] bg-[#E6E6E6] text-[#909090] hover:bg-[#D9D9D9] disabled:text-gray-400",
    ghost:
      "bg-[#E6E6E6] text-[#909090] hover:bg-[#D9D9D9] disabled:text-gray-300",
    black:
      "bg-[#111112] text-white hover:bg-[#1a1a1a] disabled:bg-gray-300 disabled:text-gray-100",
    blackMuted:
      "bg-[#111112] text-[#909090] hover:bg-[#1a1a1a] disabled:bg-gray-300 disabled:text-gray-100",
    tag:
