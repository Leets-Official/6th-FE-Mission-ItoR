...
export const S = {
  ...
  toolbarContainer:
    'flex justify-center w-full max-w-[1366px] h-[49px] px-[12px] py-[12px] gap-[32px]',
  addPhotoButton:
    'flex items-center justify-center w-[103px] h-[25px] px-[8px] py-[2px] gap-[4px] rounded-[2px] cursor-pointer disabled:opacity-50',
  ...
  titleInput:
    'w-full h-[46px] px-[16px] py-[12px] rounded-md text-gray-900 placeholder-gray-400 text-[16px] focus:outline-none focus:ring-2 focus:ring-primary',
