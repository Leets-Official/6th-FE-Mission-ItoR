export const S = {
  ...
  titleContainer: "w-full h-[114px] flex flex-col justify-center border-b border-gray-300 bg-gray-100 px-[430px]",
  ...
  profileUploadLabel: "text-[12px] text-gray-600 border border-gray-300 px-3 py-1 rounded-[2px] cursor-pointer hover:bg-gray-100 transition",

  formContainer: "flex flex-col mt-[60px] px-[430px]",
  formInner: "w-[688px] flex flex-col gap-4",
  
  errorText: "text-danger text-[12px] ml-[16px] mt-[-8px]",
  
  submitButton: "w-full h-[46px] mt-6 border border-primary rounded-full text-primary font-medium hover:bg-blue-50 transition disabled:opacity-50",
