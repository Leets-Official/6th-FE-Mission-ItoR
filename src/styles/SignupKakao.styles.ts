export const S = {
  ...
  submitButton: "w-full h-[46px] mt-6 border border-primary rounded-full text-primary font-medium hover:bg-blue-50 transition disabled:opacity-50 disabled:cursor-not-allowed",
