export const S = {
  ...
  profileUploadTitle: "text-[14px] text-[#909090]",
  ...
  socialLoginInput: "bg-[#E6E6E6] text-[#909090] disabled:bg-[#E6E6E6]",
  
  errorContainer: "text-red-500 text-sm",
  
  submitButton: "w-full h-[46px] mt-6 border border-blue-400 rounded-full text-blue-500 font-medium hover:bg-blue-50 transition disabled:opacity-50 disabled:cursor-not-allowed",
