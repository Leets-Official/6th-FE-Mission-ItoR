...
export const byVariant: Record<ButtonVariant, string> = {
  outlinePointWhite: "border border-[var(--Point)] bg-[var(--White)] text-[var(--Point)]",
  outlineGrayWhite: "border border-[var(--Gray56)] bg-[var(--White)] text-[var(--Gray56)]",
  solidWhite: "border-0 bg-[var(--White)] text-[var(--Gray56)]",
  outlineGrayGray90: "border border-[var(--Gray56)] bg-[var(--Gray90)] text-[var(--Gray56)]",
