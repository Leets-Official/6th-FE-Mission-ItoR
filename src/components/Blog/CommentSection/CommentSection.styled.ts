// 기본 섹션 구조
export const container = "w-full flex flex-col pt-8";
export const title = "text-lg font-medium mb-4 flex items-center gap-1 w-full max-w-[656px]";
export const count = "text-brand-blue text-sm font-normal";

// 댓글 리스트
export const commentList = "mt-6 flex flex-col gap-16 w-full max-w-[656px]";
export const commentItemWrapper = "flex w-full max-w-[656px] gap-2";
...
export const emptyBox =
  "w-full max-w-[656px] flex flex-col items-center justify-center text-center";
export const subText = "text-brand-textGray text-sm mb-6";
export const emptyTextarea =
  "w-full h-[106px] rounded-[4px] border border-brand-lightGray bg-brand-white flex items-center px-6 text-[15px] text-left text-brand-gray";
