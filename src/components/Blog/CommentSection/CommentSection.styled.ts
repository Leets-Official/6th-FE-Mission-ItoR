...
export const count = "text-brand-blue text-sm font-normal mb-2";
...
export const commentText = "mt-6 text-sm text-brand-darkGray leading-relaxed";
export const menuWrapper = "relative";
export const dropdownPosition = "absolute right-0 top-5 z-50";

// 댓글 입력
export const commentWrapper =
  "w-full max-w-[656px] flex flex-col bg-brand-white border border-brand-lightGray rounded-[4px] p-2 gap-2 mt-4";
